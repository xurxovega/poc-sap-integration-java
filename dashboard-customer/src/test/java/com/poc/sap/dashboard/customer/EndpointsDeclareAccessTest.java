...
/**
 * sdd/common/seguridad-api.md R-3: cada endpoint declara quien puede
 * llamarlo. Un endpoint nuevo sin @PreAuthorize rompe el build (mismo
 * mecanismo que el modulo customer).
 */
