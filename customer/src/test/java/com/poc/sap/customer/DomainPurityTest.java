 ...
 * dominio de customer no depende de ningun framework.
 */
@AnalyzeClasses(packages = "com.poc.sap.customer", importOptions = ImportOption.DoNotIncludeTests.class)
