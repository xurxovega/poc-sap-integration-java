...
| customer   | 144          | unit + slice + **`CustomerApplicationContextTest`** (smoke de contexto Spring completo) |
| article    | 43           | unit + slice + **`ArticleApplicationContextTest`** (smoke de contexto) |
