# Catálogo de contratos SAP S/4HANA Cloud

> **Contratos externos del ancla SDD**: los specs de SAP no los escribimos
> nosotros, los consumimos. Cuando una API de este catálogo cambia, se revisan
> los specs de las features que la consumen ([`README.md`](README.md) §1) antes
> de tocar adaptadores.
>
